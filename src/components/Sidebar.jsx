...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="w flex items-center justify-between px-2 py-1">
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/admin"
                              className={({ isActive }) =>
                                'relat ive  group flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
                              Home
